...
ADD Gemfile /app/
RUN yum clean all && yum install -y make gcc-c++ rh-ruby22-ruby-devel rh-ruby22-rubygem-bundler && cd /app && scl enable rh-ruby22 -- bundle install && rm -rf /var/cache/yum/*
